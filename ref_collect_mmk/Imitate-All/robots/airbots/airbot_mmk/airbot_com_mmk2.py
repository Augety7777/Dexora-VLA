...
class AIRBOTMMK2(object):
    def __init__(self, config: Optional[AIRBOTMMK2Config] = None, **kwargs) -> None:
        ...
        # # ===== 修改相机配置 =====
        # # 基础相机配置（动态加载的 cameras + 额外添加的 LEFT_CAMERA 和 RIGHT_CAMERA）
        # camera_config = {
        #     comp: {
        ...
        # 额外添加 LEFT_CAMERA 和 RIGHT_CAMERA（如果不在 self.cameras 中）
        # extra_cameras = {
        #     MMK2Components.LEFT_CAMERA: {
        #         "camera_type": "USB",
        #         # "rgb_camera.color_profile": "640,480,30",
        #         "video_device":"/dev/usbcam_113310",
        #         "image_width":"640",
        #         "image_height": "480",
        #         "framerate":"20",
        #     },
        ...
        #         "camera_type": "USB",
        #         # "rgb_camera.color_profile": "640,480,30",
        #         "video_device":"/dev/usbcam_113110",
        #         "image_width":"640",
        #         "image_height": "480",
        #         "framerate":"20",
        #     }
        ...
        # # 合并配置（Python 3.9+ 可用 | 运算符，低版本用 {**dict1, **dict2}）
        # final_camera_config = {**camera_config, **extra_cameras}

        # # 启用资源
        # self.robot.enable_resources(extra_cameras)
        # # # ===== 相机配置结束 =====
